...
import com.espark.adarsh.security.filter.JwtUsernameAndPasswordAuthenticationFilter;
...
public class SecurityCredentialsConfig extends WebSecurityConfigurerAdapter {
    ...
    // to provide our implementation for fetching user from database (or any other source).
