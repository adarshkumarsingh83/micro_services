...
public class EmployeeService {
    ...
    public Employee getEmployee(Long id, String accessToken) {
    ...
    public Employee getDefaultEmployee(Long id, String accessToken) {
    ...
    public List<Employee> getEmployees(String accessToken) {
    ...
    public List<Employee> getDefaultEmployees(String accessToken) {
